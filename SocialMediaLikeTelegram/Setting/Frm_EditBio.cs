...
{
    public partial class Frm_EditBio : Form
    {
        #region FormShadow
        ...
        private void materialFlatButton2_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(bunifuMaterialTextbox1.Text))
            {
                ...
                User.Biography = bunifuMaterialTextbox1.Text;
                Rep_Users.EditUser(User);
                this.Close();
            }
            else
                AdvanceMethod.AdvanceMessageBox("Please fill Biography !!");
        }

        private void Frm_EditBio_Load(object sender, EventArgs e)
        {
            bunifuMaterialTextbox1.Text = Rep_Users.GetUser(Frm_Chats.User_id).Biography;
        }
    }
}
