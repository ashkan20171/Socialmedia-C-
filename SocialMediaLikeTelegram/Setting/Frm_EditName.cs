...
{
    public partial class Frm_EditName : Form
    {
        #region FormShadow
        ...
        private void Frm_EditName_Load(object sender, EventArgs e)
        {
            txt_Lname.Text = Rep_Users.GetUser(Frm_Chats.User_id).Lname;
            txt_Name.Text = Rep_Users.GetUser(Frm_Chats.User_id).Name;
        }
        ...
        {
            if (!string.IsNullOrWhiteSpace(txt_Lname.Text) && !string.IsNullOrWhiteSpace(txt_Name.Text))
            {
                ...
                AdvanceMethod.AdvanceMessageBox("Please Fill Name and Lname");
        }
    }
}
