...
{
    public partial class Frm_EditUsername : Form
    {
        #region FormShadow
        ...
        private void Frm_EditUsername_Load(object sender, EventArgs e)
        {
            materialSingleLineTextField1.Text = Rep_Users.GetUser(Frm_Chats.User_id).Username;
        }
        ...
        private void materialFlatButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Rep_Users.ValidateUsername(materialSingleLineTextField1.Text))
                {
                    var User = Rep_Users.GetUser(Frm_Chats.User_id);
                    User.Username = materialSingleLineTextField1.Text;
                    Rep_Users.EditUser(User);
                    this.Close();
                }
                else
                    AdvanceMethod.AdvanceMessageBox("this username is allery exist !!");
            }
            else
